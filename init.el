...
(use-package minuet
    ...
    (plist-put minuet-openai-fim-compatible-options :end-point "http://localhost:9292/v1/completions")
    (plist-put minuet-openai-fim-compatible-options :name "Llama.cpp")
    (plist-put minuet-openai-fim-compatible-options :api-key "TERM")
    (plist-put minuet-openai-fim-compatible-options :model "FIM")
    (minuet-set-nested-plist minuet-openai-fim-compatible-options nil :template :suffix)
    (minuet-set-optional-options
     minuet-openai-fim-compatible-options
     :prompt
     (defun minuet-llama-cpp-fim-qwen-prompt-function (ctx)
       (format "<|repo_name|>%s<|file_sep|>%s<|fim_prefix|>%s<|fim_suffix|>%s<|fim_middle|>"
               (plist-get ctx :repo-path)
               (plist-get ctx :file-path)
